{{-- carrito lateral con productos cantidad y boton de compra --}}
...
<div class="flex items-center justify-between font-black uppercase text-xs mb-4 text-slate-600">
            ...
            <button type="button" id="BtnCompra" data-checkout-url="{{ route('compras.formulario') }}" onclick="GoToCompraForm()" class="w-full rounded-2xl bg-slate-900 px-4 py-4 text-[11px] font-black uppercase tracking-widest text-white transition-all hover:bg-blue-600"
            > Ir a compra
            </button>
        </div>
    </div>

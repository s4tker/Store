{{-- vista simple para crear pedidos manuales --}}
...
{{-- mensajes de validacion al crear pedido --}}
...
{{-- formulario que envia producto cantidad y direccion --}}
...
{{-- selector de direccion donde se entregara el pedido --}}
...
<div class="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <button type="submit" class="w-full rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white hover:bg-slate-800"> Confirmar pedido
                    </button>
                </form>
            </aside>
        </div>
    @else
<div class="rounded-3xl border border-dashed border-slate-300 bg-white p-10 text-center text-slate-600"> No tienes direcciones registradas. Agrega una dirección desde tu cuenta para continuar.
        </div>
    @endif
</div>
@endsection

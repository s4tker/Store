{{-- vista antigua de pedidos del usuario comentada para referencia --}}
...
<div id="PedidosEmpty" class="PedidosEmpty hidden"> Aún no tienes pedidos simulados. Genera uno desde la vista de compra.
        </div>

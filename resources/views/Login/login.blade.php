{{-- vista para iniciar sesion o crear una cuenta --}}

@extends('layouts.app')

@section('title', 'Acceso | ElectroShop')
...
<div class="text-center">
                ...
                <p class="mt-8 text-[10px] font-black uppercase tracking-[0.22em] text-slate-400">acceso</p>

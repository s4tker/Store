{{-- vista del panel con metricas ventas y productos destacados --}}
...
<div class="stats-admin-chart-stage stats-panel.compact-stage" id="TopCustomersChart"></div>
                        </div>
                    </article>
...
<div class="stats-admin-chart-stage stats-panel.compact-stage" id="StatusChart"></div>
                        </div>
                    </article>
                </div>
            </section>

    ...
    <section class="admin-card admin-product-section product-editor-card">
        ...
        >
            ...
            <div class="field-half">
                ...
                <p class="helper-admin mt-2" id="ProductNameHint"></p>
            </div>
            ...
            <div class="field-third field-metric">
                <label class="label-admin" for="InpPrecio">Precio normal</label>
                <input type="number" step="0.01" min="0.10" name="Precio" id="InpPrecio" required class="input-admin" placeholder="0.00">
            </div>

            <div class="field-third field-metric">
                <label class="label-admin" for="InpDescuentoManual">Descuento %</label>
                <input type="number" step="1" min="0" max="99" id="InpDescuentoManual" class="input-admin" placeholder="0">
            </div>

            <div class="field-third field-metric">
                <label class="label-admin" for="InpOferta">Precio final</label>
            ...
            <div class="field-span-3">
                <div class="admin-inline-header">
                    <div>
                        ...
                        <p class="helper-admin mt-2" id="ProductPresetCopy"></p>
                    </div>
    ...
    <section class="admin-product-section product-catalog-card">
        <div class="admin-card-header admin-card-header-stack">
            ...
            <div class="inline-actions">
                <button type="button" class="ghost-admin-btn admin-list-toggle" data-toggle-target="ProductListPanel" data-toggle-label-show="Ver productos" data-toggle-label-hide="Ocultar productos">Ver productos</button>
            </div>
        </div>

        <div id="ProductListPanel" class="admin-collapsible-panel hidden">
                        ...
                        <button type="button" class="product-card-main" data-load-product="{{ $producto->Id }}">
                            ...
                            <div class="product-card-copy">
                                ...
                                <div class="product-card-meta">
                                    <span>{{ $producto->imagenes->count() }} imágenes</span>
                                </div>
                            </div>
                        </button>

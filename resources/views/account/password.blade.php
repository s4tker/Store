{{-- vista para cambiar la contraseña de la cuenta --}}
...
{{-- mensajes de validacion de la nueva contraseña --}}
...
{{-- titulo para volver al perfil y cambiar contraseña --}}
        <header class="mb-8">
            ...
            <h1 class="text-2xl md:text-4xl font-black text-slate-900 tracking-tighter uppercase italic"> Cambiar <span class="text-blue-600">Contraseña</span>
            </h1>
        ...
        <!-- formulario para escribir contraseña actual y nueva -->
<div class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-slate-100">
{{-- formulario que actualiza la contraseña del usuario --}}
...
<div class="relative">
                        <input type="password" name="current_password" id="currentPass" required class="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 font-bold text-slate-900 placeholder-slate-400 pr-12">
...
<div class="relative">
                            <input type="password" name="new_password" id="newPass" required class="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 font-bold text-slate-900 placeholder-slate-400 pr-12">
...
<div class="relative">
                            <input type="password" name="new_password_confirmation" id="confirmPass" required class="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 font-bold text-slate-900 placeholder-slate-400 pr-12">
...
<div class="flex gap-3 pt-4">
                    ...
                    <a href="{{ route('account') }}" class="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-900 font-black py-4 rounded-xl uppercase text-[11px] tracking-widest transition-colors text-center"> Cancelar
                    </a>
                </div>
            </form>
...
<div class="flex items-center justify-between font-black uppercase text-xs mb-4 text-slate-600">
                ...
                <button class="w-full bg-slate-900 text-white font-black py-4 rounded-2xl opacity-60 cursor-not-allowed uppercase text-[11px] tracking-widest">Compra no disponible</button>
            </div>
        </div>
    </aside>
@endsection

{{-- vista del catalogo con categorias filtros y productos --}}
...
{{-- encabezado del catalogo con titulo y buscador --}}
<header class="mb-8">
    <h1 class="text-base sm:text-lg md:text-2xl font-black text-slate-900 tracking-tighter uppercase italic"> Explora lo <span class="text-blue-600">Último</span>
    </h1>
...
{{-- categorias usadas para navegar el catalogo --}}
...
{{-- categorias usadas para navegar el catalogo --}}
@foreach($Categorias as $categoria)
{{-- subcategorias ligadas a la categoria elegida --}}
...
{{-- grilla de productos disponibles para comprar --}}

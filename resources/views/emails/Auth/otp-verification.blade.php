{{-- correo con codigo de verificacion para activar la cuenta --}}
...
<div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:18px;padding:28px;text-align:center;">
            ...
            <p style="margin:0 0 22px;font-size:14px;line-height:1.5;color:#475569;"> Usa este codigo para completar tu registro. Expira en {{ $minutes }} minutos.
            </p>
<div style="display:inline-block;padding:16px 24px;border-radius:14px;background:#0f172a;color:#ffffff;font-size:28px;font-weight:800;letter-spacing:.22em;">
            ...
            <p style="margin:24px 0 0;font-size:12px;color:#94a3b8;"> Si no solicitaste esta cuenta, puedes ignorar este mensaje.
            </p>
        </div>
    </div>
</body>
